...
//printar nome dos cantores e de seus albuns
//criar uma lista vazia e ir adicionando com o .apend a cada iteracao true
//usar o filter

const cantoresEAlbuns = [];

albuns.forEach(album => {
    let cantor = cantores.filter( cantor => cantor.nome === album.cantor);
    cantor.forEach( cantor => {
        cantoresEAlbuns.push(` ${cantor.nome}: ${album.nome}`)
    });
